...
if (process.env.VCAP_SERVICES) {
  ...
  mongo = {
    ...
    port:     27017,
    ssl:      false,
    url:      'mongodb://159.203.32.219:27017/db',
    username: 'ccbot-admin',
  };
}
...
module.exports = {
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || 'frank',
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 'malibuto09)',
  },
